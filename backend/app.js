...
app.post('/tasks', async (req, res) => {
  ...
  if (!taskText || taskText.trim().length === 0) {
    ...
    return res.status(422).json({ message: 'Invalid task text.' });
  }
...
mongoose.connect(
  `mongodb://${process.env.MONGODB_USERNAME}:${process.env.MONGODB_PASSWORD}@mongodb:27017/tasks?authSource=admin`,
  {
